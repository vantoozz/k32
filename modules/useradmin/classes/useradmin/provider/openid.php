...
class Useradmin_Provider_OpenID extends Provider {
	...
	protected static $config = array(
		...
		'yandex' => array('url' => 'http://openid.yandex.ru/'),
		'mailru' => array('url' => 'http://openid.mail.ru/mail/'),
	);
	...
	{
		return isset($this->data['namePerson/first']) ? $this->data['namePerson/first'] : '';	
	}
	
	
	public function last_name()
	{
		return isset($this->data['namePerson/last']) ? $this->data['namePerson/last'] : '';	
	}
	
	 /**
     * @return string The access token (empty string for OpenID)
     */
